...
const val EXTRA_CREATED_ON_TIMESTAMP = "created_on_timestamp"
const val EXTRA_CHECKSUM_AUDIO = "checksum_audio"
...
const val ACTIVE_PLAYLIST_PLAYED = "active_playlist_played"
const val AUTO_QUEUE_ENABLED = "auto_queue_enabled"
const val AUTO_QUEUE_PLAYLIST_ID = "auto_queue_playlist_id"
const val AUTO_QUEUE_INTERVAL_MINUTES = "auto_queue_interval_minutes"
const val AUTO_QUEUE_LAST_ADDED_TIMESTAMP = "auto_queue_last_added_timestamp"
const val AUTO_QUEUE_TRACK_TO_REMOVE_NEXT = "auto_queue_track_to_remove_next"
...
const val TAB_GENRES = 8
const val TAB_TEXT = 16
const val ACTIVITY_PLAYLIST_FOLDER = 64

const val FLAG_MANUAL_CACHE = 1
const val FLAG_IS_CURRENT = 2

const val ALL_TABS_MASK = TAB_PLAYLISTS or TAB_FOLDERS or TAB_TRACKS or TAB_TEXT
