            ...
            activity.runOnUiThread {
                ...
                if (adapter == null) {
                    TracksAdapter(activity = activity, recyclerView = binding.tracksList, sourceType = TracksAdapter.TYPE_TRACKS, items = tracks) {
                        // DISABLED: Click does nothing in "All Tracks" view
                        // This prevents accidental playback and app freeze with 8000+ tracks
                        // To play a track, use playlists, albums, or artists view instead
                    }.apply {
