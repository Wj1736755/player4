    ...
    override fun setupFragment(activity: BaseSimpleActivity) {
        ...
        ensureBackgroundThread {
            ...
            playlists.forEach {
                ...
                durations[it.id] = context.audioHelper.getPlaylistTotalDuration(it.id)
            }
            ...
            activity.runOnUiThread {
                ...
                if (adapter == null) {
                    PlaylistsAdapter(activity, playlists, binding.playlistsList) {
                        ...
                        // Set durations for all playlists
                        durations.forEach { (playlistId, duration) ->
                            setPlaylistDuration(playlistId, duration)
                        }
                    }
                    ...
                    (adapter as PlaylistsAdapter).apply {
                        updateItems(playlists)
                        // Update durations for all playlists
                        durations.forEach { (playlistId, duration) ->
                            setPlaylistDuration(playlistId, duration)
                        }
                    }
