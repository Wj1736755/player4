...
class QueueActivity : SimpleControllerActivity() {
    ...
    private var showTranscriptionMode = false
    ...
    private fun setupAdapter() {
        withPlayer {
            ...
            val currAdapter = binding.queueList.adapter
            if (currAdapter == null || (currAdapter as? QueueAdapter)?.showTranscription != showTranscriptionMode) {
                ...
                getAdapter()?.updateItems(tracks, forceUpdate = true)
            }
        }
    }
    ...
    private fun createPlaylistFromQueue() {
        NewPlaylistDialog(this) { newPlaylistId ->
            ...
            ensureBackgroundThread {
                RoomHelper(this).insertTracksWithPlaylist(tracks, newPlaylistId)
            }
        }
    }
}
