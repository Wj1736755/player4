...
class TrackActivity : SimpleControllerActivity(), PlaybackSpeedListener {
    ...
    override fun onResume() {
        ...
        binding.activityTrackTranscription.setTextColor(getProperTextColor())
        updatePlayerState()
        updateTrackInfo()
    }
    ...
    private fun setupTrackInfo(item: MediaItem?) {
        ...
        binding.apply {
            ...
            if (!track.transcription.isNullOrBlank()) {
                activityTrackTranscription.text = track.transcription
                activityTrackTranscription.setOnLongClickListener {
                    copyToClipboard(track.transcription!!)
                    true
                }
            } else {
                activityTrackTranscription.text = "no transcription"
                activityTrackTranscription.setOnLongClickListener(null)
            }
            activityTrackTranscription.beVisible()
